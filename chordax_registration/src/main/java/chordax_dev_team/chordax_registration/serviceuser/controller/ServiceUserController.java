...
public class ServiceUserController {
	...
	@GetMapping("")
	public ServiceUser getServiceUser(@RequestParam String email, @RequestParam String password) {

		// gets existing user by email
		ServiceUser existingServiceUser = serviceUserRepository.findByEmail(email);
	...
	// to INSERT user
	@PostMapping("")
	public ServiceUser addServiceUser(@RequestBody ServiceUser serviceUser) {
